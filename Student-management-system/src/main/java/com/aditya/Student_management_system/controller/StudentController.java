package com.aditya.Student_management_system.controller;
...
public class StudentController
{
    ...
    //handler method to handle the list of students
    @GetMapping("/students")
    ...
    public String saveStudent(@Valid @ModelAttribute(value = "student") StudentDto student,
